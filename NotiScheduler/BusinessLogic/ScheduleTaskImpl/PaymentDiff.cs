...
namespace NotiScheduler.BusinessLogic.ScheduleTaskImpl {
    class PaymentDiff : ScheduleTask {

        protected static readonly ILog log = LogManager.GetLogger(typeof(Program));
        private readonly string FILE_SHOT_NAME = "PaymentDIff";
        ...
        public void Execute(NotificationSchedulerVO vo) {
            ...
            try {
                var list = sd.getPaymentDiffData();
                var fileHelper = new FileHelper<PaymentDiffVO>();
